...
public class CharMovement : MonoBehaviour
{
    ...
    {   
        if (other.CompareTag("Car"))
        {
            ...
            Debug.Log("Sheep and car collided, game should be over");
        ...
        else if (other.CompareTag("Coin"))
        {
            ...
            Debug.Log("Sheep and coin collided, coin should be collected");
            // destroy the coin
        ...
        {
            Debug.Log("Sheep and eagle collided, game should be over");
